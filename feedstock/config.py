...
c.Bake.prune = False
c.LocalDirectBakery.num_workers = 6
...
c.InputCacheStorage.fsspec_class = 's3fs.S3FileSystem'
c.InputCacheStorage.root_path = 's3://carbonplan-scratch/pyramid_hang_test/cache/'
