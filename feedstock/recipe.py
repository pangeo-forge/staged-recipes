...
dates = [
    ...
    for d in pd.date_range('2001-01-01', '2001-02-01', freq='D')
]
URL_FORMAT = (
...
pyramid_pattern = pattern_from_file_sequence(
    [
        "s3://veda-pforge-emr-outputs-v4/gpm_imerg_1mo.zarr"
    ],
    concat_dim="time",
)
...
with beam.Pipeline(runner=PySparkRunner()) as pyramid_pipeline:
    (
        ...
        | StoreToPyramid(
        target_root=target_root,
        store_name='gpm_imerg_pyramid_1mo.zarr',
        epsg_code='4326',
