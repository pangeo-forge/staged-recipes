...
def make_url1(time):
    return "ftp://ftp.gfdl.noaa.gov/pub/William.Gregory/SIC_observations_NT/nt_"+time+".ice_daily.ens_mean.nc"
...
def make_url5(record):
    return "ftp://ftp.gfdl.noaa.gov/pub/William.Gregory/SICDA_posteriors_F02/"+record+".output_mean.nc"
